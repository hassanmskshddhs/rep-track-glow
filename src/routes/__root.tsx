...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Log your Push / Pull / Legs / Upper workouts and track progressive overload." },
      { property: "og:title", content: "IronLog — Track Your Lifts" },
      { name: "twitter:title", content: "IronLog — Track Your Lifts" },
      { property: "og:description", content: "Log your Push / Pull / Legs / Upper workouts and track progressive overload." },
      { name: "twitter:description", content: "Log your Push / Pull / Legs / Upper workouts and track progressive overload." },
